                       ...
                       const U32 forCCtx)
{
    ...
    size_t const optPotentialSpace =
      ...
      + ZSTD_cwksp_alloc_size(3 * (ZSTD_OPT_NUM+1) * sizeof(ZSTD_match_t))
                ...
                const ZSTD_resetTarget_e forWho)
{
    ...
    if ((forWho == ZSTD_resetTarget_CCtx) && (cParams->strategy >= ZSTD_btopt)) {
        ...
        ms->opt.matchTable = (ZSTD_match_t*)ZSTD_cwksp_reserve_aligned(ws, 3* (ZSTD_OPT_NUM+1) * sizeof(ZSTD_match_t));
